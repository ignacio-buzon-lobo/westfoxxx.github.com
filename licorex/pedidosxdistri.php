   ...
   <div class="panel panel-left fondo-panel">
    ...
    <div class="view view-main">
      ...
      <div data-name="home" class="page">
        ...
        <div class="block-title">PEDIDOS DEL DISTRIBUIDOR:</div>
...
// Obtener el nombre del distribuidor desde la URL
$distribuidor_id = $_GET['distribuidor_id'];
// Se hace una consulta a la base de datos para obtener los datos del pedido
$sql = $pdo->query("SELECT * FROM pedidos WHERE distribuidor_id = $distribuidor_id ORDER BY fecha_creacion DESC");
